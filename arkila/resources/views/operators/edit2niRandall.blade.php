                ...
                <div class="tab">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input  value = "{{old('contactNumber') ?? $operator->contact_number }}" id="contactNumberO" name="contactNumber" type="text" class="form-control" placeholder="Contact Number">
                        </div>
            ...
            <div class="tab">
                ...
                <div class="tab">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="contactNumberO">Contact Number</label>
                            <input value="{{ old('contactPersonContactNumber') ?? $operator->emergency_contactno }}" id="contactNumberO" name="contactPersonContactNumber" type="text" class="form-control" placeholder="Contact Number">
                        </div>
                    </div>
                </div>
                <div class="tab">
