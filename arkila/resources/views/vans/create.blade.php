...
<div class="form-group">
    ...
    <input list="models" value="{{old('vanModel')}}" name="vanModel" type="text" class="form-control" maxlength="50" placeholder="Van Model">
    <datalist id="models">
...
<div class="form-group">
    ...
    <input value="{{old('seatingCapacity')}}" name="seatingCapacity" type="number" class="form-control" placeholder="Seating Capacity" max="15" min="1">
</div>
